...
switch($proceso){
	case 'Registro':
		mysql_query("INSERT INTO proveedores (nomb_prove, tipo_prove, direccion_prove, celular_prove, fecha_reg_prove, cuil_prove, email_prove)VALUES('$nombre','$tipo','$direccion','$celular', '$fecha', '$cuil', '$email')");
	break;
	
	case 'Edicion':
		mysql_query("UPDATE proveedores SET nomb_prove = '$nombre', tipo_prove = '$tipo', direccion_prove = '$direccion', celular_prove = '$celular', cuil_prove = '$cuil', email_prove = '$email' WHERE id_prove = '$id'");
	break;
}
