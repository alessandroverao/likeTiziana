...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'TODOS LOS PROVEEDORES', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
$pdf->Ln(10);
...
$productos = mysql_query("SELECT * FROM proveedores"); 
...
while($productos2 = mysql_fetch_array($productos)){
	...
	$pdf->Cell(30, 8, $productos2['tipo_prove'], 0);
	$pdf->Cell(40, 8, $productos2['direccion_prove'], 0);
...
$pdf->Output('reporteTodosLosProveedores.pdf','I');
?>