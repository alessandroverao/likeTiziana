...
<body>
	<h1><big><strong><font color="#333333">TODOS LOS PRODUCTOS</strong></big></h1>
	<hr>
	<ul>
		<li><form><button onclick="javascript:reportePDF();" class="btn btn-danger">Exportar a PDF</button></form></li>
		<li><a href="todosLosProductosExcel.php"><button class="btn btn-success">Exportar a EXCEL</button></a></li>
