...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'VENTAS DEL DIA', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
$pdf->Ln(10);
...
$productos = mysql_query("SELECT * FROM productos, tipoproductos, clientes, ventas, detalleventa WHERE fecha_venta = '$fecha' AND id_venta = id_venta_detalle AND id_prod = id_prod_detalle AND id_clien_venta = id_clien AND estadodetalle=0 AND tipo_prod = id_tipo_pro"); 
$item = 0;
$totaluni = 0;
...
$pdf->Output('reporteVentasDelDia.pdf','I');
?>