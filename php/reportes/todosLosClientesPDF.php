...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'TODOS LOS CLIENTES', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
$pdf->Ln(10);
...
$productos = mysql_query("SELECT * FROM clientes, tipoclientes WHERE tipo_clien = id_tipo_client ORDER BY nomb_clien ASC"); 
...
$pdf->Output('reporteTodosLosClientes.pdf','I');
?>