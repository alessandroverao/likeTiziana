...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysql_query("SELECT * FROM productos, tipoproductos, clientes, ventas, detalleventa WHERE fecha_venta BETWEEN '$fecha1' AND '$fecha2' AND id_venta = id_venta_detalle AND id_prod = id_prod_detalle AND id_clien_venta = id_clien AND estadodetalle=0 AND tipo_prod = id_tipo_pro"); 
$item = 0;
$totaluni = 0;
...
$pdf->Output('reporteVentasEntreFechas.pdf','I');
?>