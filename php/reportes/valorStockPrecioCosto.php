...
<head>
	...
	<title>Valor stock precio costo</title>
	...
	<script>
		$(document).on('ready', function(){
		    ...
		    for (i = 0, j = rows.length; i < j; ++i) {
		        ...
		        valorASumar = cells[4].innerHTML * cells[5].innerHTML;
...
<body>
	<h1><big><strong><font color="#333333">VALOR STOCK PRECIO COSTO</strong></big></h1>
	<hr>
	<ul>
	...
	<div class="registros" id="venta">
        <table class="table table-striped table-condensed table-hover">
            <tr>
                ...
                <th width="250">Código de Barras</th>
                <th width="250">Tipo</th>
                <th width="250">Precio Costo</th>
                <th width="250">Existencia</th>
                <th width="250">TOTAL</th>
            </tr>
	<?php
		include('../../php/conexion.php');

        $registro = mysql_query("SELECT * FROM productos, tipoproductos WHERE tipo_prod = id_tipo_pro");
        if(!empty($registro)){
	        while($registro2 = mysql_fetch_array($registro)){
	        	echo '<tr>
	                        ...
	                        <td>'.$registro2['precio_cost'] * $registro2['existencia_prod'].'</td>
	                </tr>'; 
	       	}
       }
    ?>
    ...
    <script>
    	function reportePDF(){
			window.open('valorStockPrecioCostoPDF.php');
			history.back();
		}
    </script>
</body>
