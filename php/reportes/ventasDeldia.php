...
<body>
	...
	<?php
        ...
        $registro = mysql_query("SELECT * FROM productos, clientes, ventas, detalleventa WHERE fecha_venta = '$fecha' AND id_venta = id_venta_detalle AND id_prod = id_prod_detalle AND id_clien_venta = id_clien AND estadodetalle=0"); 
        if(!empty($registro)){
